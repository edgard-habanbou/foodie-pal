...
const getRecipes = async (req, res) => {
    ...
    messages: [
      {
        ...
        you should return only a JSON object with this format: [{id:id(from 0 and add 1 for each item), title: recipe name, description:desc, calories: how many calories, time: how much time (45m, 1hr...), instructions:["instruction1", "instruction2"...], ingredients: ["ingredient1", "ingredient2" ...]}]
  ...
  res.send({
    message: JSON.parse(chatCompletion.choices[0].message.content),
  });
};
module.exports = {
  getRecipes,
